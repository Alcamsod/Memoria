...
\begin{itemize}
    \item \textbf{Identificación:} El modelo SARIMAX viene caracterizado por los parámetros $(p,d,q)x(P,D,Q,s)$ donde:
    \begin{itemize}
...
En nuestro caso, para determinar los órdenes de los parámetros del modelo, se analizan las funciones de autocorrelación (ACF) y autocorrelación parcial (PACF). La ACF mide la correlación de la serie consigo misma en diferentes rezagos, mientras que la PACF mide esta misma correlación eliminando la influencia de los rezagos intermedios.\\
...
La predicción con XGBoost se realiza paso a paso, como la SARIMAX.
%
%
%
\subsubsection{TFT}
...
\begin{figure}[H]
    ...
    \caption{Arquitectura del TFT \cite{TFT}}
