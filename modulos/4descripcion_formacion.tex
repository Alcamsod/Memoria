...
\caption{Fragmento del código de \textit{web scraping} en Python [\Cref{WBSCode}].}
\label{webscraping}
\end{subfigure}
\hfill
...
\caption{Ejemplo de configuración de Terraform para el \textit{scheduler} [\Cref{TFCode}].}
\label{terraform}
\end{subfigure}
